...
public class ConnectionPool {
	...
	public void init2() throws ConnectionPoolException {
		...
		try {
			...
			throw new ConnectionPoolException("db.prorerties error", e);
	...
	public Connection takeConnection() throws ConnectionPoolException {
		...
		try {
			/*
			 * if (freeConnections == null) { System.out.println("bedaaa"); }
			 */
	...
	// con = DriverManager.getConnection("jdbc:mysql://127.0.0.1/mydb2", "root",
	// "12345");
}
